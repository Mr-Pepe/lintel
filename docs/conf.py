...
# lintel documentation build configuration file, created by
...
version = lintel.__version__
# The full version, including alpha/beta/rc tags.
release = lintel.__version__
...
man_pages = [('index', 'lintel', 'lintel Documentation', ['Amir Rachum'], 1)]
