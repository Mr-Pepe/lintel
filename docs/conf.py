...
# pydoclint documentation build configuration file, created by
...
version = pydoclint.__version__
# The full version, including alpha/beta/rc tags.
release = pydoclint.__version__
...
htmlhelp_basename = 'pydoclintdoc'
...
man_pages = [('index', 'pydoclint', 'pydoclint Documentation', ['Amir Rachum'], 1)]
